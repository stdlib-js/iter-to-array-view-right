...
```javascript
iterator2arrayviewRight = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/iter-to-array-view-right@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/iter-to-array-view-right@umd/bundle.js"></script>
```
