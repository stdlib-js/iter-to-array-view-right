...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/iter-to-array-view-right/tags). For example,

```javascript
iterator2arrayviewRight = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/iter-to-array-view-right@v0.2.3-umd/browser.js' )
```
